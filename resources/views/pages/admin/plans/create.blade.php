                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="features" rows="5" placeholder="Support dédié&#10;Visibilité premium&#10;Statistiques avancées..."
                                      class="w-full border border-gray-200 dark:border-gray-700 rounded-xl dark:bg-gray-800 focus:ring-gold focus:border-gold px-4 py-3">{{ old('features') }}</textarea>
