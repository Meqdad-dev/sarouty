...
@section('page_subtitle', 'Ajustez le style, les quotas et la visibilité du forfait')
...
@section('content')
    <form action="{{ route('admin.plans.update', $plan) }}" method="POST" class="space-y-6"
          x-data='planDesigner(@json($themePresets), @json(old("theme_color", $plan->theme_key)))'>
        @csrf
        @method('PUT')
                ...
                <div class="panel p-6 rounded-2xl">
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Modifiez le nom, la tarification et le contenu affiché au public.</p>
                        </div>
                    </div>
                ...
                <div class="panel p-6 rounded-2xl">
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Contrôlez les limites et avantages accordés à ce plan.</p>
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="rounded-[26px] overflow-hidden border shadow-sm"
                        ...
                        <div class="p-5">
                            ...
                            <div class="mt-4 text-sm text-gray-600 space-y-1">
                                <div>• Couleur appliquée dans l'admin</div>
                                <div>• Badge cohérent dans les listes</div>
                                <div>• Harmonisation avec la page tarifs</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel p-6 rounded-2xl">
                    ...
                    @if($plan->slug !== 'gratuit')
                        ...
                        <p class="text-xs text-gray-500 mt-2">Décochez pour masquer temporairement ce forfait.</p>
                    @else
                        ...
                        <div class="flex items-center gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 rounded-lg text-sm">
                            ...
                            Le plan gratuit reste toujours actif.
                        </div>
                    @endif
                </div>
            </div>
